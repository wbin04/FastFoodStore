...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="col_info">
            	<div class="managerAddVoucher_form">
                    <div class="back addVoucher_back">
                        <a href = "adminManagePromo">
                            <i class="fa-solid fa-arrow-left"></i>
                            Quay lại
                        </a>
                    </div>
                    <div class="addVoucherLabel">Thông tin mã giảm giá mới</div>
                    <div class="addVoucher_container">
                    	<div class="addVoucher_set">
                            <div class="voucher_label">ID mã</div>
                            <input type="text" name="" id="setVoucherId" class="setVoucher_ID">
                            <!-- <div class="voucherVND">VNĐ</div> -->
                        </div>
                        <div class="addVoucher_set">
                            <div class="voucher_label">Giảm giá</div>
                            <input type="text" name="" id="setVoucherDiscount" class="setVoucher_discount">
                            <div class="voucherVND">VNĐ</div>
                        </div>
                        <div class="addVoucher_set">
                            <div class="voucher_label">Đơn tối thiểu</div>
                            <input type="text" name="" id="setVoucherMinPay" class="setVoucher_minOrder">
                            <div class="voucherVND">VNĐ</div>
                        </div>
                    ...
                    <div class="addOption">
                        ...
                        <button class="optAdd option_addVoucherBtn btnAddVoucher">Thêm mã giảm giá</button>
                    </div>
                </div>
            </div>
            <div id="showCalendar">
        ...
        <script src = "js/adminAddVoucher.js"></script>
    </body>
</html>        